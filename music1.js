...
function playSong(song) { cover.src = song.album.cover_big; title.textContent = song.title; artist.textContent = song.artist.name; audio.src = song.preview; player.classList.remove('hidden'); audio.play(); }
